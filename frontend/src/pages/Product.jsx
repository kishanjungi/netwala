      ...
      <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
        ...
        <div className='flex-1 flex flex-col-reverse gap-3 sm:flex-row'>
          ...
          <div className='flex-1'>
            ...
            <p className='mt-5 text-gray-500 md:w-4/5'>{productData.description1}</p>
            <p className='mt-5 text-gray-500 md:w-4/5'>{productData.description2}</p>
            <p className='mt-5 text-gray-500 md:w-4/5'>{productData.description3}</p>
            <p className='mt-5 text-gray-500 md:w-4/5'>{productData.description4}</p>
            ...
            <button onClick={()=>addToCart(productData._id,size)} className='bg-black mt-10 text-white px-8 py-3 text-sm active:bg-gray-700'>ADD TO CART </button>
